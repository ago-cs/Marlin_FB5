...
#define STRING_CONFIG_H_AUTHOR "(Andrei, FlyingbearGhost5)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 161.6, 800, 850 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 43, -50, -1.95 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT (43)    // X point for Z homing when homing all axes (G28). // 43 - 43 = 0
  #define Z_SAFE_HOMING_Y_POINT (5)    // Y point for Z homing when homing all axes (G28).  // 5 -- 50 = 45
#endif
